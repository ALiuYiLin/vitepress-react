...
或者，你可以使用 [Algolia DocSearch](#algolia-search) 或一些社区插件，例如：[vitepress-plugin-search](https://www.npmjs.com/package/vitepress-plugin-search)、[vitepress-plugin-pagefind](https://www.npmjs.com/package/vitepress-plugin-pagefind) 或者 [vitepress-plugin-cloudflare-ai-search](https://www.npmjs.com/package/vitepress-plugin-cloudflare-ai-search)。
...
<Snippet src="@/snippets/algolia-i18n.ts" />
...
<Snippet src="@/snippets/algolia-crawler.js" />
