...
export namespace DefaultTheme {
  /**
   * The layout state of the current page, as consumed by `useLayout` from
   * `vitepress/theme`. (React adaptation: plain snapshot values, where the
   * upstream Vue types used refs/computed.)
   */
